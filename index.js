...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    const newArr = zooAnimals.map((name) => {
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const newArr = zooAnimals.filter((name) => {
  ...
  */
  ...
  function USApop(zooAnimals){
    const newArr = zooAnimals.reduce((total, pop) => {
...
function greeting(firstName, lastName){
  ...
  console.log(consume("daniel", "castillo", greeting));
